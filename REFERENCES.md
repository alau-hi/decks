...
| Stat | Printed | Source |
|---|---|---|
| **Steel** — 18% imported | [AISI, "Steel Imports Down 12.6% in 2025" (Feb 2026)](https://www.steel.org/2026/02/steel-imports-down-12-6-in-2025/) — 18% of apparent consumption 2025, 23% in 2024. The 2025 fall is tariff-driven (Section 232: 25% Mar 2025, 50% Jun 2025). **Reverted to the sourced 18% (2025) per Alex 2026-08-29**, after briefly printing 20%. 18% is AISI's figure for 2025; 23% was 2024. |
| Primary **Aluminum** — 85% imported | [Aluminum Association / Wittsend, "Powering Up American Aluminum" (May 2025)](https://www.aluminum.org/sites/default/files/2025-05/PoweringUpAluminum_WhitePaper_2025.pdf) ([local copy](sources/PoweringUpAluminum_WhitePaper_2025.pdf)) — US primary aluminum demand 4.4M t/yr against 683,500 t from the four remaining smelters → imports cover 84.5%. Same paper carries the 4-smelters-from-33-in-1980 figure, no longer printed as its own stat. **Label matters: this is primary (new) metal only** — see the correction note below. |
| **Data Centers** — 60% steel | **Basis (Alex, 2026-08-27): the building and its contents, EXCLUDING concrete** — foundations and slab, where most of the concrete goes, are out of scope. Traced 2026-08-27: originates in `../superwood-datacenter` slide 16, flagged unsourced there and inherited through investor-overview (unverified, conf L) without ever being sourced. No published source states a steel share on any basis — see the note below. |
