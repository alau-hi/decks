...
def campus(values, out, xlabel, log, narrow, unit, carbon=False):
    ...
    a.xaxis.set_major_formatter(FuncFormatter(lambda v,_: f"{v*1000:,.0f}"))
    if log: a.xaxis.set_major_locator(LogLocator(base=10,numticks=6)); a.xaxis.set_minor_formatter(FuncFormatter(lambda v,_: ""))
...
campus(mass,"prep/charts/campus_mass.png","tons per 1 GW data center, high case — log scale",True,False,"tons")
campus(carbv,"prep/charts/campus_carbon.png","tons CO₂e per 1 GW data center, high case — steel, concrete and plastic content; steel 1.8 kg/kg, concrete 0.12, polymers 3.0",False,False,"tons CO₂e",True)
campus(mass,"prep/charts/campus_mass_narrow.png","Mass — tons per GW (log scale)",True,True,"tons")
campus(carbv,"prep/charts/campus_carbon_narrow.png","Embodied carbon — tons CO₂e per GW (steel, concrete and plastic content)",False,True,"tons",True)
...
years=['2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025']; vals=[1.8, 2.75, 4.12, 4.67, 6.93, 8.48, 9.23, 9.95, 12.58, 20.0, 34.8, 49.74]; t12=67.06; saar=75.166
...
a.set_xticks(x+[len(years)]); a.set_xticklabels(years+["2026\nest."],fontsize=8,color=DIM)
