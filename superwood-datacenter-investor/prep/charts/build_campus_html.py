...
def rows_html(view):
    ...
    for title,n in GROUPS:
        ...
        i+=n
    return out
AX_M='<div class="hb ax"><span class="hl"></span><div class="tr ticks"><span style="left:8.0%">1,000</span><span style="left:34.4%">10,000</span><span style="left:60.9%">100,000</span><span style="left:87.4%">1,000,000</span></div><span class="hv">tons, log scale</span><span></span></div>'
AX_C='<div class="hb ax"><span class="hl"></span><div class="tr ticks"><span style="left:0%">0</span><span style="left:20%">100,000</span><span style="left:40%">200,000</span><span style="left:60%">300,000</span><span style="left:80%">400,000</span><span style="left:100%">500,000</span></div><span class="hv">tons CO₂e</span><span></span></div>'
