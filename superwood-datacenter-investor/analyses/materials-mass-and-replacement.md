...
| **Long term** | Concrete: 75% of slab-on-grade and paving, 90% of foundations, footings, piers and pads, with the rebar in each; server enclosures (30% of IT mass; rack cabinets are *Soon*); fan blades (2% of mechanical mass, needs investigation) — never the electronics | ChipMill-scale products | Stated technical potential (Alex, 2026-09-01 and 2026-09-04); no design or code pathway yet |
...
| Mechanical equipment, piping, loop water | — | — | 25% | 2% | 5,400–13,500 tons | 1,620–8,100 tons | Shells, casings and fan-wall frames medium term (Alex 2026-09-06); fan blades long term, needs investigation; compressors, pumps, tubes, piping and water stay |
| IT — servers and racks | — | 18% | — | 30% | 7,200–33,600 tons | 2,160–20,160 tons | Rack cabinets soon (18% of IT mass), server enclosures long term (30%), per analyses/it-rack-material-stack.md; electronics never. Rack masses [H]; aggregate [L] |
...
| IT — servers and racks | equipment | 1.14 | 17,100–79,800 tons CO₂e |
...
- Concrete intensity scope, resolved 2026-09-06 by reading the sources: the arXiv preprint (Eslami 2025, section 3.1) gives "5,000 and 10,000 cubic meters" per 10 MW with no scope, citing Hasan et al. 2022 and Sharma et al. 2023. Hasan et al. 2022 (J. Eng. Exact Sci., an energy-efficiency review) contains no concrete quantity at all. Sharma et al. 2023 is Schneider Electric White Paper 99: a hypothetical 1 MW Tier 3 facility of 12,895 ft² (1,198 m²) with core-and-shell embodied carbon at 0.23 t CO₂e/m² from EC3, 276 t CO₂e, of which concrete is 85% (233 t). At 0.3–0.4 t CO₂e per m³ that is roughly 600–800 m³ of concrete per MW, which is where the 500–1,000 m³/MW range comes from. It is the building core and shell only (foundations, slab, structure of the hall) for a low-density 6 kW/rack design at ~13,000 ft²/MW; site paving, parking, yards and equipment pads are not in it. The model's "slab on grade, paving, yard" row therefore carries no site paving today; a hyperscale hall at 5,000–10,000 ft²/MW would have less building concrete per MW, and the site work would be additional.
