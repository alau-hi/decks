...
| 11 | Soon | "Soon: applications requiring straightforward testing and engineering" | Acoustic barrier tile is a fine vertical fluted-slat screen after a reference photo from Alex (2026-09-05); walkways tile is slender outdoor decking outside an office wing, not chunky platform timber (Alex 2026-09-05); racks belong here — a few months of development; gates in plain words, no standards |
...
| 13 | Long term | Prefabricated envelopes, then foundations  | Long-term vision slide Alex asked for; labeled technical potential; no 5%/three-quarters mass lines; text only, no renderings (Alex 2026-09-05: "we are not ready yet for that"); closing lines verbatim from Alex 2026-09-05: envelopes "Hyperscalers are asking for this now, to simplify design and delivery and accelerate schedules."; foundations "Biggest unaddressed impact both to speed of development and construction, and with huge carbon impact. Geotechnical requirements greatly impact schedule and site selection." |
