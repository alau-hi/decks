...
| 17 | Carbon | Embodied carbon: a projection until the LCA is complete | Alex 2026-09-05: show SUPERWOOD at about 0.1–0.2 kg CO₂e per kg of steel substituted, and a carbon storage component of −0.5 to −1.5 kg CO₂e per kg of SUPERWOOD (shown left of zero on the same axis). Both steel baselines kept; reductions recomputed (89–94% vs BF-BOF, 50–86% vs EAF); biogenic still reported separately. The Canva 0.5 kg/kg manufacturing figure is no longer printed on this slide (0.5 × 0.3–0.6 = 0.15–0.30, which does not match 0.1–0.2 — open item) |
