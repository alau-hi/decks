...
| 4 | Pushback | Headline on the strength of community pushback; we help with aesthetics and noise today and can go much further, into structures and contents, leading into slide 5 | Added 2026-09-05; Alex: headline = how strong pushback is, body = aesthetics and noise only; then "way too wordy" — cut to one sentence per point. Noise answer also names sound-damping ductwork and fan enclosures as a potential (Alex 2026-09-05). Two blocks (aesthetics, noise) each ending in what SUPERWOOD offers; scale card from Data Center Watch Q1 2026; ordinance examples (Henry County VA 1,000 ft / 50 dBA, Virginia 500 ft, Calvert County MD). Power, water and rates named as out of scope in one line only; polls removed |
