...
| 11 | Soon | "Soon: applications requiring straightforward testing and engineering" | First tile is now "Fan enclosures & ducting" with a wooden fan-box render (Alex 2026-09-05), replacing "Acoustic barrier walls & equipment screens"; the fluted-slat screen render became the security-fence tile on slide 10 (and the Microsoft card); "What it needs" gates removed from every tile (Alex 2026-09-05); walkways tile is slender outdoor decking outside an office wing, not chunky platform timber (Alex 2026-09-05); racks belong here — a few months of development; gates in plain words, no standards |
