...
| 7 | Worth | Just one data center can consume the entire output of a SUPERMILL | Rebuilt 2026-09-05 (Alex: too much duplicate information). Title verbatim. One table only: horizon, SUPERWOOD required, years of mill output; chart, "incumbent replaced" column and the capacity card removed; mill capacities as a legend line; long-term row is concrete and rebar only (server boxes removed 2026-09-05: 56,000–346,000 tons, 1.8–11 yr); years of mill output also shown as a range bar per row on a 0–12 year scale with a one-year tick (Alex 2026-09-05); no dollar values; racks in "soon" |
...
| 11 | Soon | "Soon: applications requiring straightforward testing and engineering" | Acoustic barrier tile is a vertical board-and-batten screen (Alex 2026-09-05); racks belong here — a few months of development; gates in plain words, no standards |
| 12 | Structural | Structural: starting now, scaling with SuperMill Two | Left block label "Under development with SUPERMILL ONE output": truss design starting; mass-timber enhancement under way; light structural components (non-life-safety: strut-type supports, window mullions, deck boards). Left block is text only (its truss image repeated the truss card; Alex 2026-09-05); CLT card leads with SUPERWOOD hybrid glulam assemblies and shows the hybrid beam; "Heavy equipment supports" card no longer mentions server enclosures; "Window mullions" card replaces "Building enclosures" (Alex 2026-09-05: full building enclosures belong to the long-term slide). Qualification band in plain words; do not say "this is what Microsoft and Google are asking about" |
| 13 | Long term | Prefabricated envelopes, then foundations (no server boxes anywhere in the deck — Alex 2026-09-05) | Long-term vision slide Alex asked for; labeled technical potential; no 5%/three-quarters mass lines; text only, no renderings (Alex 2026-09-05: "we are not ready yet for that"); closing lines verbatim from Alex 2026-09-05: envelopes "Hyperscalers are asking for this now, to simplify design and delivery and accelerate schedules."; foundations "Biggest unaddressed impact both to speed of development and construction, and with huge carbon impact. Geotechnical requirements greatly impact schedule and site selection." |
