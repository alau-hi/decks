...
| 4 | Pushback | Headline on the strength of community pushback; two complaints about the building (aesthetics, noise) with the SUPERWOOD answer; closing tease "We can go much further" leads into slide 5 | Added 2026-09-05. Alex: headline = strength of pushback; body = aesthetics and noise only; "much further" is a tease at the end, not in the title; "way too many words" twice — one short sentence per point. Fan enclosures and ductwork named as a potential noise answer. Each SUPERWOOD answer sits in its own gold-labeled box under the complaint (Alex 2026-09-05: easier to read and distinguish). Power, water and rates only in the footnote |
...
| 10 | Now | Skins, screens and fences from SuperMill One | Racks are NOT here (see 12); biophilic interiors tile is the SUPERMILLS Investor Overview's mass-timber server hall render (app_hall_servers, "our more dramatic image", Alex 2026-09-05); label shortened to "Biophilic interiors" because the image is a data hall, not an office |
| 11 | Soon | "Soon: applications requiring straightforward testing and engineering" | First tile is now "Fan enclosures & ducting" with the fan-box render Alex picked from Higgsfield (share nLNFBaR1P-o, 2026-07-25 generation; Alex 2026-09-05), replacing "Acoustic barrier walls & equipment screens"; the fluted-slat screen render became the security-fence tile on slide 10 (and the Microsoft card); "What it needs" gates removed from every tile (Alex 2026-09-05); walkways tile is slender outdoor decking outside an office wing, not chunky platform timber (Alex 2026-09-05); racks belong here — a few months of development; gates in plain words, no standards |
...
| 13 | Long term | Long term (5+ years): prefabricated envelopes, then foundations | Long-term vision slide Alex asked for; labeled technical potential; no 5%/three-quarters mass lines; text only, no renderings (Alex 2026-09-05: "we are not ready yet for that"); closing lines verbatim from Alex 2026-09-05: envelopes "Hyperscalers are asking for this now, to simplify design and delivery and accelerate schedules."; foundations "Biggest unaddressed impact both to speed of development and construction, and with huge carbon impact. Geotechnical requirements greatly impact schedule and site selection." |
